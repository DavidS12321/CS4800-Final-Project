...
public class Main {
	public static void main(String[] args) {
		...
		List<menuItem> menuOne = Arrays.asList(beans, cheese, chili);
		...
		Customer customer = (Customer) UserFactory.createUser("Customer", "Alice", "123 Main St", "LA County", null, DietaryRestriction.VEGAN, null, null, null, null);
		Driver driver = (Driver) UserFactory.createUser("Driver", "Driver 1", "101 Pine St", "LA County", Shift.SECOND_SHIFT, null, null, null, null, null);
		Restaurant restaurant = (Restaurant) UserFactory.createUser("Restaurant", "The Good Food", "111 Cedar St", "LA County", null, null, "00:00 - 22:00", "Mexican", menuOne, meals);
		...
		List<Driver> drivers = Arrays.asList(
				(Driver) UserFactory.createUser("Driver", "Driver 1", "101 Pine St", "LA County", Shift.SECOND_SHIFT, null, null, null, null, null)
				//(Driver) UserFactory.createUser("Driver", "Driver 2", "202 Maple St", "Orange County", Shift.SECOND_SHIFT, null, null, null, null, null)
